...
function GetBooking() {
    ...
    data = { "action": "getbookingdetails","id":user }
    console.log(data)
    $.post("Model/cus_viewbooking.py", data, function (res) {
        res = JSON.parse(res)
        console.log(res)
        if (res != null) {
            $("#tb").show()
            ...
            $('.del').click(function (e) {
                ...
                if (confirm("Remove this item from your cart ? ")) {
                    ...
                    data = { "data": data, "action": "cart" }
                    $.post('Model/delete_cart.py', data, function (dt) {
                        location.reload();
                        showDetails()
                    })
                }
